...
Your additions should be both reasonably difficult and quick to finish. The point of the test should always be to observe and learn the candidate's methods and thought processes as we supply inceasingly complex problems. A good test should **never** try to eliminate a candidate through [arbitrary hardness][2].
